...
手机 / 桌面 App
-> 用户自己的 Cloud Inbox
   iCloud / 坚果云 / OneDrive / Google Drive / Syncthing / 本地文件夹
-> 电脑本地同步文件夹
-> Sherlockdogs 本地后台任务
-> 本地 Markdown 图书馆
-> 可选 Codex 对话
...
| Windows 兼容性 | 当前 Windows 包仍需要更多真机验证 | 公测前做真实 Windows smoke test |
